      ...
      <div className="mb-6">
        <div className="grid grid-cols-4 gap-2.5">
          ...
          {visibleDefaultImages.map((defaultImg) => (
            ...
            >
              <img src={defaultImg} className="h-30 w-full object-cover rounded-md" alt={defaultImg} />

              {/* Remove Button Overlay for default images too */}
              <Button
                onClick={() => removeImage(defaultImg)}
                variant="outline"
                size="icon"
        ...
        {images.length > 0 && (
          <div className="grid grid-cols-3 gap-2.5 mt-4 ml-1.5 mr-1.5">
